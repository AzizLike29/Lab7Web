...
<body>
  ...
  <section id="about">
    <div class="row">
      <img src="Aziz.jpg" title="Aziz" alt="Aziz" class="image-circle" width="150" style="text-align: center; border: 2px solid brown; border-radius: 10px; margin-left: 130px; margin-bottom: 15px;">
