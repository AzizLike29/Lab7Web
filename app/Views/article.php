...
<body>
  ...
  <section id="about">
    <div class="row">
      <img src="seblak.jpg" title="makanan" alt="makanan" class="image-circle" width="150" style="text-align: center; border: 2px solid brown; border-radius: 10px; margin-left: 130px; margin-bottom: 15px;">
